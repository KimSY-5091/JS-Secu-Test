    ...
    function callRequestUrl(url, params, method) {
        ...
        for(var key in params) {
            if(params.hasOwnProperty(key)) {
                ...
                formInnerHtml += '<input type="hidden" name="' + escapeInput(key) + '" value="' + escapeInput(params[key]) + '" />';
            }
        }

        formInnerHtml += '<input type="hidden" name="' + 'url' + '" value="' + escapeInput(getStripUrl(reportUrl)) + '" />';
        var wholeHtml = "<html><head></head><body><form name='myform' method='" + method +
                        "' action='" + escapeInput(url) + "'>" + formInnerHtml + "</form>" + "</body></html>";
        ...
        formDoc.write(DOMPurify.sanitize(wholeHtml));
            ...
            if (target == null) {
                ...
                for (var key in printParameter) {
                    if (printParameter.hasOwnProperty(key)) {
                        ...
                        formInnerHtml += '<input type="hidden" name="' + escapeInput(key) + '" value="' + escapeInput(printParameter[key]) + '" />';
                    }
                }

                formInnerHtml += '<input type="hidden" name="' + 'url' + '" value="' + escapeInput(getStripUrl(reportUrl)) + '" />';
                var wholeHtml = "<html><head></head><body><form name='myform' method='" + method +
                                "' action='" + escapeInput(jspUrl) + "'>" + formInnerHtml + "</form>" + "</body></html>";
